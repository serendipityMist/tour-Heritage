...
const Calendar = ({ currentMonth, setCurrentMonth, events, setEvents }) => {
  ...
  return (
    <div className="bg-[#FFFFFF] p-4 rounded shadow-lg">
      {/* Month Navigation */}
      ...
      <div className="grid grid-cols-7 gap-2 text-center mt-2">
        {daysInMonth.map((day, idx) => {
          ...
          return (
            <div
              key={idx}
              className={`h-20 border rounded flex flex-col items-center justify-start p-1 cursor-pointer ${
      ...
      <div className="bg-[#f1EFEC] min-h-screen">
        <div className="container mx-auto px-4 py-12 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            <div className="bg-[#FFFFFF] shadow-md rounded-lg p-6 hover:shadow-lg transition duration-300">
              <h3 className="text-xl font-semibold mb-2 text-[#283A2C]">
                Heritage Walks
              </h3>
          ...
          <div className="bg-gradient-to-r from-[#283A2C] via-[#DADDC5] to-[#f1EFEC] text-[#283A2C] p-8 mt-12 rounded-lg shadow-xl">
            <div className="text-center mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-[#FFFFFF] text-[#283A2C] shadow-md rounded-lg p-6 hover:shadow-lg transition duration-300">
              ...
              <div className="bg-[#FFFFFF] text-[#283A2C] shadow-md rounded-lg p-6 hover:shadow-lg transition duration-300">
                <h3 className="text-2xl font-semibold mb-2">Cooking Demos</h3>
                <p>
